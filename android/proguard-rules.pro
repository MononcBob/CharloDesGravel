...
-keepclassmembers class io.netty.** {
    @io.netty.util.internal.UnstableApi <methods>;
}
...
# --- Garnotte Rules ---
-keep class com.mariogravel.garnotte.** { *; }
...
-keep class kotlinx.serialization.internal.GeneratedSerializer { *; }
-keepclassmembers class * {
    kotlinx.serialization.KSerializer serializer(...);
}

# --- BouncyCastle (Cryptographie) ---
